    ...
    <transition-group name="list-complete" class="tab-list" ref="navTab">
      ...
      <el-popover
        ...
        <span
          slot="reference"
          class="is-more">
          <el-button round :type="activeIndex >= maxLen ? 'primary' : 'default'">更多</el-button>
        </span>
      </el-popover>
    </transition-group>
    <span class="quick-operate">
      <el-tooltip effect="dark" content="主页" placement="bottom-start">
...
export default {
  ...
  methods: {
    ...
    hanlerClear() {
      this.$confirm(`您即将关闭${this.tabsLen}个标签, 是否继续?`, '提示', {
